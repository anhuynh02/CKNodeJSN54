// function toggleSideBar(sidebar, content, ml){    
//     $('#btn-toggle-sidebar').click(() => {
//         console.log('abc')
//         // let bs = 'col-6 col-sm-4 col-md-3 col-lg-2'
//         if(sidebar.hasClass(bs)){
//             // Close
...
// function getInvoiceDetailIds(){
//     $(`#dashboard-pane tbody tr td`).click(function(evt){
//         let invoiceDetailIds = $(this).siblings().first().text().split(',')
//         // console.log(ids)
//         let path = window.location.pathname.split('/').slice(0, 3).join('/') + '/invoice-details'
//         // console.log(path)
//         fetch(`${path}`, {
//             method: 'post',
//             headers: {
...
//               },
//             body: JSON.stringify({invoiceDetailIds})
//         })
//         // setHref(lengthDefaultUrl, `/${id}`)
//     })
// }
